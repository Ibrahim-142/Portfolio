...
const ContactSection = () => {
    const contactLinks = [
        {
            title: "Email",
            value: "ibrahimkhurshid65@gmail.com",
            href: "mailto:ibrahimkhurshid65@gmail.com",
            icon: Mail
        },
        {
            title: "GitHub",
            value: "github.com/Ibrahim-142",
            href: "https://github.com/Ibrahim-142",
            icon: Github
        },
        {
            title: "LinkedIn",
            value: "linkedin.com/in/muhammad-ibrahim-a5609728a",
